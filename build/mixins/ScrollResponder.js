...
/**
   ...
   */
scrollResponderScrollTo:function scrollResponderScrollTo(offsetX,offsetY){var animated=arguments.length<=2||arguments[2]===undefined?true:arguments[2];},
...
/**
   ...
   */
scrollResponderZoomTo:function scrollResponderZoomTo(rect){var animated=arguments.length<=1||arguments[1]===undefined?true:arguments[1];
...
this.addListenerOn(_DeviceEventEmitter2.default,'keyboardWillShow',this.scrollResponderKeyboardWillShow);
this.addListenerOn(_DeviceEventEmitter2.default,'keyboardWillHide',this.scrollResponderKeyboardWillHide);
